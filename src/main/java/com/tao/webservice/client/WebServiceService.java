 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://webService.hai.tao.com/", wsdlLocation = "http://localhost:8090/service/webService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://webService.hai.tao.com/", "WebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/service/webService?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://webService.hai.tao.com/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.hai.tao.com/", "WebServicePort"), WebService.class, features);
    }
