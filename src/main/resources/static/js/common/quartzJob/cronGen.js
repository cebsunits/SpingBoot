(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $('<li/>', { 'class': 'active',style:'width:50px' }).html($('<a id="SecondlyTab" href="#Secondly">秒</a>')).appendTo(topMenu);
            $('<li/>', { style:'width:60px'}).html($('<a id="MinutesTab" href="#Minutes">分钟</a>')).appendTo(topMenu);
            $('<li/>', { style:'width:60px'}).html($('<a id="HourlyTab" href="#Hourly">小时</a>')).appendTo(topMenu);
            $('<li/>', { style:'width:50px'}).html($('<a id="DailyTab" href="#Daily">日</a>')).appendTo(topMenu);
            $('<li/>', { style:'width:50px'}).html($('<a id="MonthlyTab" href="#Monthly">月</a>')).appendTo(topMenu);
            $('<li/>', { style:'width:50px'}).html($('<a id="WeeklyTab" href="#Weekly">周</a>')).appendTo(topMenu);
            $('<li/>', { style:'width:50px'}).html($('<a id="YearlyTab" href="#Yearly">年</a>')).appendTo(topMenu);
    ...
    var refreshRunTime = function () {
        $.ajax({
            type : 'GET',
            url : "/common/quartzJob/nextTriggerTime",
            data : {
